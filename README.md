...
```javascript
slastIndexOfRow = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-slast-index-of-row@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var slastIndexOfRow = require( 'path/to/vendor/umd/blas-ext-base-slast-index-of-row/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-slast-index-of-row@umd/browser.js"></script>
```
...
#### slastIndexOfRow.ndarray( M, N, A, strideA1, strideA2, offsetA, x, strideX, offsetX, workspace, strideW, offsetW )
...
var out = slastIndexOfRow( order, shape[ 0 ], shape[ 1 ], A, strides[ 0 ], x, 1, workspace, 1 );
console.log( out );
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-slast-index-of-row.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-slast-index-of-row

[test-image]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-slast-index-of-row/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-slast-index-of-row?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-slast-index-of-row.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-slast-index-of-row/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-slast-index-of-row/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-slast-index-of-row/main/LICENSE
